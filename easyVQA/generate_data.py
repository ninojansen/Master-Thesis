...
# TODO
# Diversify data
# -Create regions for the shapes to appear in i.e upper-left centre upper right etc
# -Questions regarding the size of the shape/ small/medium/large etc
# -Multiple shapes/ overlapping shapes
# -Image morphing?
# -Have certain color/shape combininations not occur in testing set
# -Diversify possible answers
